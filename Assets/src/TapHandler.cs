...
public class TapHandler : MonoBehaviour
{
    ...
    //    // Only process if we haven't already handled this prefab
    //    if (scoreManager != null)
    //    {
    //        scoreManager.IncrementScore();
    //    }
    ...
    //    // Notify GameEndManager that questionnaire is complete
    //    if (gameEndManager != null)
    //    {
    //        gameEndManager.OnQuestionnaireCompleted();
    //    }
    ...
    //    currentActivePrefab = null; // Important to reset
    //}
    //public void OnQuestionnaireSubmit()
    //{
    ...
    //    {
    //        Debug.LogError("No current active prefab!");
    //        return;
    //    }

    //    if (currentActivePrefab.questionnairePanel == null)
    //    {
    //        Debug.LogError("Questionnaire panel reference is null!");
    //        return;
    //    }
    ...
    //    bool isCorrect = playerAnswer.Equals(
    //        currentActivePrefab.questionData.correctAnswer,
    ...
    //    // Increment score only after questionnaire is submitted
    //    if (scoreManager != null)
    //    {
    //        scoreManager.IncrementScore();
    //    }
    ...
    //    // Check for game end after questionnaire is closed
    //  //  CheckForGameEnd();
    //}
